    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-6xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">Connect, collaborate, and chat in beautiful virtual spaces</p>
        </div>
              ...
              <div className="space-y-6 max-w-2xl mx-auto">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {mapTypes.map(map => (
                        ...
                        >
                          <div className={`h-16 bg-gradient-to-r ${map.color} rounded-lg flex items-center justify-center text-2xl mb-2`}>
                            {map.preview}
                          </div>
                          <h4 className="font-medium text-sm text-gray-800">{map.name}</h4>
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 disabled:from-gray-300 disabled:to-gray-300 text-white py-4 rounded-xl font-medium text-lg transition-all duration-200 hover:shadow-lg disabled:cursor-not-allowed"
                  >
